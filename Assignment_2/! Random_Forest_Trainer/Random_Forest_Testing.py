...
X, y = make_classification(n_samples=1000, n_features=255,
...
roc_auc = roc_auc_score(Y_Test_Bin, Y_Pred_Test_Bin, multi_class='ovr', average='weighted')
precision = precision_score(y_true=Y_Test_Bin, y_pred=Y_Pred_Test_Bin, average='weighted')
f1_score = metrics.f1_score(Y_Test_Bin, Y_Pred_Test_Bin, average='weighted')
accuracy_score = metrics.accuracy_score(Y_Test_Bin, Y_Pred_Test_Bin)
recall_score = metrics.recall_score(Y_Test_Bin, Y_Pred_Test_Bin, average='weighted')
...
filename1 = ("C:\\Users\\jllef\\OneDrive\\Desktop\\2024 Classes\\! Machine Learning CSEN-4375\\Assignments\\Assignment_2\\! Random_Forest_Trainer\\K-Fold_Results\\Testing Scores")
i = 0
